        ...
        return `
          <div class="admin-event-card">
            ...
            <div style="margin-top: 15px;">
              <button onclick="window.editEvent(${event.id})" class="btn btn-primary" style="margin-right: 10px;">Edit</button>
              <button onclick="window.deleteEvent(${event.id})" class="btn btn-secondary">Delete</button>
            </div>
          </div>
        `;
      }).join('');
...
module.exports = { initAdminPage, loadAdminEvents, loadAdminMessages };
